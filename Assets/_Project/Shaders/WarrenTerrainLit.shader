Shader "Universal Render Pipeline/Terrain/WarrenLit"
{
    Properties
    {
    ...
    //#include "Packages/com.unity.postprocessing/PostProcessing/Shaders/Outline.hlsl"
            //#include "Assets/_Project/Shaders/StdLib.hlsl"
    ENDHLSL
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/_Project/Shaders/TerrainLitInput2.hlsl"
            //#include "Assets/_Project/Shaders/Outline.hlsl"
