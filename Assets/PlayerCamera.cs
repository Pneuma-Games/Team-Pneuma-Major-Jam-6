...
namespace Monster.Player
{
    public class PlayerCamera : MonoBehaviour
    {
        ...
        // public void AutoTurnTowards(Vector3 point, Action callback)
        // {
        //     // use for turning towards the source of player's death.
        //     _camTransform.DOLookAt(point, 1.5f, AxisConstraint.None, Vector3.up).OnComplete(() =>
        //     {
        //         callback?.Invoke();
        //     });
        // }
